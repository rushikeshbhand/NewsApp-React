  ...
  render() {
    const articles = [
      {
        ...
        "title": "Melania Trump’s mother has died - - The Associated Press CNN  US Central Command says - CNN",
        "description": "Amalija Knavs, the mother of former first lady Melania Trump, has died, Trump posted on her social media accounts.in one of the largest Houthi attacks to take place in the Red Sea in recent months.",
      ...
      },
      {
        ...
        "title": "US Navy shoots down barrage of Houthi missiles and drones launched from Yemen over Red Sea",
      ...
      },
      {
        ...
        "title": "Armed men storm an Ecuador TV studio during a live broadcast as attacks in the country escalate",
        "description": "Authorities in Ecuador say masked men broke onto the set of a public television channel in Ecuador waving guns and explosives during a live broadcast, prompting the president to issued a decree prompting the president",
    ...
    return (
      <div className='container my-1'>
        <h3 className='border-bottom border-dark'>Latest-News</h3>
        <div className="row mt-3">
          {articles.map((article, index) => (
            <div className="col-md-3 mx-4 text-center" key={index}>
              <NewsItem
                title={article.title}
